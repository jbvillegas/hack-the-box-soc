...
However, we see the same as when working on the Windows GUI here. We are logged in as a user on a computer with a specific name, and we know which directory we are in when we navigate through our system. Bash prompt can also be customized and changed to our own needs. The adjustment of the bash prompt is outside the scope of this module. However, we can look at the **bash-prompt-generator and powerlin**e, which gives us the possibility to adapt our prompt to our needs.
## Summary

This section explains **Prompt Description**. It focuses on the main ideas and practical examples.
...
I learned the basic ideas behind **Prompt Description** and how they can help me investigate and respond to security activity.
