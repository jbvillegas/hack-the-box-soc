...
```shellsession
villegasjb@htb[/htb]$ ssh htb-student@[IP address]
```
## Summary

This section explains **System Information**. It focuses on Logging In via SSH.
...
I learned the basic ideas behind **System Information** and how they can help me investigate and respond to security activity.
