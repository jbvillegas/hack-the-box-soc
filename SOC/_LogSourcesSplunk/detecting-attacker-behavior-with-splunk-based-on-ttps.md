...
1. **Example: Detection Of Reconnaissance Activities Leveraging Native Windows Binaries**  
    ...
    ![Splunk search results showing system executable paths, command lines, and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/156.png)  
...
2. **Example: Detection Of Requesting Malicious Payloads/Tools Hosted On Reputable/Whitelisted Domains (Such As githubusercontent.com)**  
    ...
    ![Splunk search results showing PowerShell and svchost executable paths with GitHub query names and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/141.png)  
...
3. **Example: Detection Of PsExec Usage**  
    ...
    **Case 1: Leveraging Sysmon Event ID 13**
    ...
    ![Splunk search results showing file names, computer names, executable paths, registry details, event times, and counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/142.png)  
    ...
    **Case 2: Leveraging Sysmon Event ID 11**
    ...
    ![Splunk search results showing Windows Update log file paths and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/143.png)  
    ...
    **Case 3: Leveraging Sysmon Event ID 18**
    ...
    ![Splunk search results showing pipe names and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/144.png)  
...
4. **Example: Detection Of Utilizing Archive Files For Transferring Tools Or Data Exfiltration**  
    ...
    ![Splunk search results showing computer names, users, target filenames, and event counts for zip, rar, and 7z files.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/145.png)  
...
5. **Example: Detection Of Utilizing PowerShell or MS Edge For Downloading Payloads/Tools**  
    ...
    ![Splunk search results showing PowerShell executable paths, target filenames, and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/155.png)
    ...
    ![Splunk search results showing target filenames with Zone.Identifier and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/147.png)  
...
6. **Example: Detection Of Execution From Atypical Or Suspicious Locations**  
    ...
    ![Splunk search results showing download paths for PsExec64.exe, SharpHound.exe, and randomfile.exe with event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/148.png)  
...
7. **Example: Detection Of Executables or DLLs Being Created Outside The Windows Directory**  
    ...
    ![Splunk search results showing users, target filenames, and event counts for executable and DLL files.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/149.png)  
...
8. **Example: Detection Of Misspelling Legitimate Binaries**  
    ...
    ![Splunk search results showing images, command lines, parent images, and parent command lines with event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/150.png)  
...
9. **Example: Detection Of Using Non-standard Ports For Communications/Transfers**  
    ...
    ![Splunk search results showing source IPs, destination IPs, destination ports, and event counts.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/151.png)  
...
This section explains **Detecting Attacker Behavior With Splunk Based On TTPs**. It focuses on Crafting SPL Searches Based On Known TTPs, Practical Exercises.
...
I learned the basic ideas behind **Detecting Attacker Behavior With Splunk Based On TTPs** and how they can help me investigate and respond to security activity.
