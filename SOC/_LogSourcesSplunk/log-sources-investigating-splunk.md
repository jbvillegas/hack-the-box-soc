...
12. **The lookup command**  
    ...
    ![Splunk interface for adding a new lookup table file. Destination app is 'search', uploading 'malware_lookup.csv', with the destination filename 'malware_lookup.csv'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/218/110.png)
...
This section explains **Introduction To Splunk & SPL**. It focuses on What Is Splunk?, Splunk As A SIEM Solution, How To Identify The Available Data, Practical Exercises.
...
I learned the basic ideas behind **Introduction To Splunk & SPL** and how they can help me investigate and respond to security activity.
