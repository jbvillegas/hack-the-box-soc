...
This section explains **Windows Event Logs**. It focuses on Windows Event Logging Basics, The Anatomy of an Event Log, Leveraging Custom XML Queries, Useful Windows Event Logs.
...
I learned the basic ideas behind **Windows Event Logs** and how they can help me investigate and respond to security activity.
